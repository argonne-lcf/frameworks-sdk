...
if [ -z "$CMAKE_ARGS" ]; then
    if [ "$#" -eq 0 ]; then
        CMAKE_ARGS=( 
            ...
            -DCMAKE_C_COMPILER=/opt/aurora/25.273.0/spack/unified/1.1.0/install/linux-x86_64/llvm-develop-git.5708851-pc5csj5/bin/clang
            -DCMAKE_CXX_COMPILER=/opt/aurora/25.273.0/spack/unified/1.1.0/install/linux-x86_64/llvm-develop-git.5708851-pc5csj5/bin/clang++
            -DLLVM_ENABLE_LLD=ON
            ...
            -DCMAKE_C_FLAGS:STRING=--gcc-install-dir=/opt/aurora/25.273.0/spack/unified/1.1.0/install/linux-x86_64/gcc-13.4.0-7zr4nbc/lib/gcc/x86_64-pc-linux-gnu/13.4.0
            -DCMAKE_CXX_FLAGS:STRING=--gcc-install-dir=/opt/aurora/25.273.0/spack/unified/1.1.0/install/linux-x86_64/gcc-13.4.0-7zr4nbc/lib/gcc/x86_64-pc-linux-gnu/13.4.0
...
cmake "${CMAKE_ARGS[@]}"
echo "Building LLVM"
ninja -C "$LLVM_BUILD_PATH" 2>&1 | tee ${LOG_FILE}
