...
CONDA_ENV_NAME=icu_73_vllm_0.15.0_no_build_isolation_nre_ipex_2.10.10_pytorch_2.10.0_rel_oneapi_2025.3.1_numpy_2.2.6_python_3.12.8
...
TMP_WORK=/lus/tegu/projects/datasets/software/26.26.0/wheelforge/repositories/vllm_0.15.0_01_29_2026
cd $TMP_WORK
...
pip install --no-deps --no-cache-dir --force-reinstall --no-build-isolation $LOCAL_WHEEL_LOC/vllm-*.whl 2>&1 | tee ${TMP_WORK}/${CONDA_ENV_NAME}/"vllm-install-$(tstamp).log"
