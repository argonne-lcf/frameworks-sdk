...
export http_proxy=http://proxy.alcf.anl.gov:3128
#
CONDA_ENV_INSTALL_DIR=/lus/tegu/projects/datasets/software/26.26.0/wheelforge/envs/trial_envs
CONDA_ENV_NAME=conda_no_deps_vllm_0.15.0_no_build_isolation_nre_ipex_2.10.10_pytorch_2.10.0_rel_oneapi_2025.3.1_numpy_2.2.6_python_3.12.8
...
TMP_WORK=/lus/tegu/projects/datasets/software/26.26.0/wheelforge/envs/trial_envs/tmp_work
cd $TMP_WORK
...
#echo "Finished building vllm/0.16.0rc0, ipex/2.10.10+xpu triton_xpu_3.6.0 for PyTorch 2.9.1 wheel with numpy 2.2.6 with oneapi/2025.3.1"

LOCAL_WHEEL_LOC=${TMP_WORK}/${CONDA_ENV_NAME}
pip install --no-deps --no-cache-dir --force-reinstall --no-build-isolation $WHEELHOUSE_TMP/vllm-0.15.0+xpu-py3-none-any.whl 2>&1 | tee ${TMP_WORK}/${CONDA_ENV_NAME}/"vllm-install-$(tstamp).log"
