...
CONDA_ENV_NAME=dpctl_0.21.1_no_deps_conda_vllm_0.15.0_nre_ipex_2.10.10_pytorch_2.10.0_rel_oneapi_2025.3.1_numpy_2.2.6_python_3.12.8_RC1
...
pip install --no-deps --no-cache-dir --force-reinstall --no-build-isolation ${LOCAL_WHEEL_LOC}/dpctl-*.whl 2>&1 | tee ${TMP_WORK}/${CONDA_ENV_NAME}/"dpctl-install-$(tstamp).log"
