...
CONDA_ENV_NAME=scikit_2025.10.1_torchcomms_0.1.0_no_deps_conda_vllm_0.15.0_nre_ipex_2.10.10_pytorch_2.10.0_rel_oneapi_2025.3.1_numpy_2.2.6_python_3.12.8
...
conda create python=3.12.8 icu=73 glog gflags fmt \
...
TMP_WORK=/lus/tegu/projects/datasets/software/26.26.0/wheelforge/repositories/scikitlearn_intelex_2025.10.1_02_05_2026
...
#git clone git@github.com:uxlfoundation/scikit-learn-intelex.git
...
#echo "Finished building scikit_learn_intelex/2025.10.1, ipex/2.10.10+xpu triton_xpu_3.6.0 for PyTorch 2.9.1 wheel with numpy 2.2.6 with oneapi/2025.3.1"

LOCAL_WHEEL_LOC=${TMP_WORK}/${CONDA_ENV_NAME}
pip install --no-deps --no-cache-dir --no-build-isolation ${LOCAL_WHEEL_LOC}/scikit_learn_intelex-*.whl 2>&1 | tee ${TMP_WORK}/${CONDA_ENV_NAME}/"deepspeed-install-$(tstamp).log"
echo "Finished installing deepspeed/0.18.5 the wheel and dependencies"
