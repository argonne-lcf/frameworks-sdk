...
CONDA_ENV_NAME=pytorch_2.10.0_rel_oneapi_2025.3.1_pti_0.16.0_numpy_2.2.6_python_3.12.8
...
TMP_WORK=/lus/tegu/projects/datasets/software/26.26.0/wheelforge/repositories/pytorch_2.10.0_01_27_2026
cd $TMP_WORK
...
echo "Finished building PyTorch 2.10.0 release wheel with oneapi/2025.3.1, PTI-0.16.0 and numpy-2.2.6"
