...
CONDA_ENV_NAME=torchvision_0.25.0_nre_ipex_2.10.10_pytorch_2.10.0_rel_oneapi_2025.3.1_numpy_2.2.6_python_3.12.8
...
TMP_WORK=/lus/tegu/projects/datasets/software/26.26.0/wheelforge/repositories/torchvision_0.25.0_01_29_2026
cd $TMP_WORK
...
pip install --no-cache-dir -r ${WHEELHOUSE_TMP}/torchvision_0.25.0_ipex_2.10.10_pytorch_2.10.0_combined_requirements.txt
...
echo "Finished building torchvision/0.25.0, ipex/2.10.10+xpu triton_xpu_3.6.0 for PyTorch 2.9.1 wheel with numpy 2.2.6 with oneapi/2025.3.1"
