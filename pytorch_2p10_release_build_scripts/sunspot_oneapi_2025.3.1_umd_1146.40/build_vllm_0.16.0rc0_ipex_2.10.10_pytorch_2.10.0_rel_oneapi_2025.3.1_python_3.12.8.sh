...
CONDA_ENV_NAME=vllm_0.16.0rc0_nre_ipex_2.10.10_pytorch_2.10.0_rel_oneapi_2025.3.1_numpy_2.2.6_python_3.12.8
...
TMP_WORK=/lus/tegu/projects/datasets/software/26.26.0/wheelforge/repositories/vllm_0.16.0-rc0_01_30_2026
cd $TMP_WORK
...
pip install --no-cache-dir -r ${WHEELHOUSE_TMP}/vllm_0.16.0rc0_xpu_separate_requirements.txt
...
pip install --no-deps --no-cache-dir --force-reinstall $LOCAL_WHEEL_LOC/vllm-*.whl 2>&1 | tee ${TMP_WORK}/${CONDA_ENV_NAME}/"vllm-install-$(tstamp).log"
