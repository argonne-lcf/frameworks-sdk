...
CONDA_ENV_NAME=jax_0.5.0_no_deps_conda_vllm_0.15.0_nre_ipex_2.10.10_pytorch_2.10.0_rel_oneapi_2025.3.1_numpy_2.2.6_python_3.12.8_RC2
...
pip install --no-deps --no-cache-dir --force-reinstall --no-build-isolation ${WHEELHOUSE_DOWNLOAD}/intel_extension_for_openxla-*.whl 2>&1 | tee ${TMP_WORK}/${CONDA_ENV_NAME}/"opexla-install-$(tstamp).log"
