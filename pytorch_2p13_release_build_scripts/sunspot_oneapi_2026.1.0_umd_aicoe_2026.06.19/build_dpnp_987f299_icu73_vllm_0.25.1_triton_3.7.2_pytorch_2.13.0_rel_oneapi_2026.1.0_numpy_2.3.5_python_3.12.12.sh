...
CONDA_ENV_NAME=dpnp_987f299_icu73_vllm_0.25.1_triton_3.7.2_nre_pt_2.13.0_rel_one_2026.1.0_np_2.3.5_python_3.12.12
...
## CHANGE HERE!!!
TMP_WORK=/lus/tegu/projects/datasets/software/26.181.0/wheelforge/repositories/dpnp_987f299_07_29_2026
cd $TMP_WORK
...
python setup.py bdist_wheel --dist-dir ${TMP_WORK}/${CONDA_ENV_NAME} -- \
    ...
    2>&1 | tee ${TMP_WORK}/${CONDA_ENV_NAME}/"dpnp-build-whl-$(tstamp).log"
echo "Finished building dpnp+git987f299, triton_xpu_3.7.2 for PyTorch 2.13.0 wheel with numpy 2.3.5 with oneapi/2026.1.0"
