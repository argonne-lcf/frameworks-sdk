...
CONDA_ENV_NAME=h5py_3.16.0_mpi4py_4.1.2_nre_pt_2.13.0_rel_one_2026.1.0_np_2.3.5_python_3.12.12
...
## CHANGE HERE!!!
TMP_WORK=/lus/tegu/projects/datasets/software/26.181.0/wheelforge/repositories/h5py_3.16.0_07_22_2026
cd $TMP_WORK
...
echo "Finished building h5py/3.16.0, triton_xpu_3.7.2 for PyTorch 2.13.0 wheel with numpy 2.3.5 with oneapi/2026.1.0"
...
h5cc -showconfig
echo ""
echo "Finished installing the h5py/3.16.0 wheel with numpy/2.3.5 and dependencies"
