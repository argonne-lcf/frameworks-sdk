...
CONDA_ENV_NAME=mpi4py_4.1.1_nre_pt_2.13.0_rel_one_2026.1.0_np_2.3.5_python_3.12.12
...
## CHANGE HERE!!!
TMP_WORK=/lus/tegu/projects/datasets/software/26.181.0/wheelforge/repositories/mpi4py_4.1.1_07_21_2026
cd $TMP_WORK
...
echo "Finished building mpi4py/4.1.1, triton_xpu_3.7.2 for PyTorch 2.13.0 wheel with numpy 2.3.5 with oneapi/2026.1.0"
...
echo "Finished installing the mpi4py/4.1.1 wheel with numpy/2.3.5 and dependencies"
