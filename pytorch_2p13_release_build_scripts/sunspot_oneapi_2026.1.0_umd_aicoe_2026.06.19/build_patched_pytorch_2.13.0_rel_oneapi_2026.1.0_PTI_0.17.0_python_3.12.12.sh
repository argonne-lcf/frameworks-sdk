...
CONDA_ENV_NAME=patched_pytorch_2.13.0_rel_oneapi_2026.1.0_pti_0.17.0_numpy_2.5.1_python_3.12.12
...
## CHANGE HERE!!!
TMP_WORK=/lus/tegu/projects/datasets/software/26.181.0/wheelforge/repositories/pytorch_2.13.0_patched_08_02_2026
cd $TMP_WORK
...
pip install --no-cache-dir numpy==2.5.1
...
python setup.py bdist_wheel --dist-dir ${TMP_WORK}/${CONDA_ENV_NAME} 2>&1 | tee ${TMP_WORK}/${CONDA_ENV_NAME}/"torch-build-whl-$(tstamp).log"
echo "Finished building PyTorch 2.13.0 release wheel with oneapi/2026.1.0, PTI-0.17.0 and numpy-2.5.1"
