...
CONDA_ENV_NAME=torchao_0.17.0__nre_pt_2.13.0_rel_one_2026.1.0_np_2.3.5_python_3.12.12
...
## CHANGE HERE!!!
TMP_WORK=/lus/tegu/projects/datasets/software/26.181.0/wheelforge/repositories/torchao_0.17.0_07_22_2026
cd $TMP_WORK
...
python setup.py bdist_wheel --dist-dir ${TMP_WORK}/${CONDA_ENV_NAME} 2>&1 | tee ${TMP_WORK}/${CONDA_ENV_NAME}/"torchao-build-whl-$(tstamp).log"
echo "Finished building torchao/0.17.0, triton_xpu_3.7.2 for PyTorch 2.13.0 wheel with numpy 2.3.5 with oneapi/2026.1.0"
...
echo "Finished installing the torchao/0.17.0 wheel with numpy/2.3.5 and dependencies"
