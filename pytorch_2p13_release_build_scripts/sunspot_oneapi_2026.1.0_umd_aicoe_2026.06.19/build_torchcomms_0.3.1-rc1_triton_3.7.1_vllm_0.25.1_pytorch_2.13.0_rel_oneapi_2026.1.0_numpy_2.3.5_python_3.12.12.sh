...
CONDA_ENV_NAME=triton_3.7.1_torchcomms_0.3.1-rc1_vllm_0.25.1_nre_pt_2.13.0_rel_one_2026.1.0_np_2.3.5_python_3.12.12
...
pip install --no-deps --no-cache-dir --force-reinstall ${WHEELHOUSE_DOWNLOAD}/triton_xpu_3.7.1/triton_xpu-*.whl
...
echo "Finished building torchcomms/0.3.1-rc1, triton_xpu_3.7.1 for PyTorch 2.13.0 wheel with numpy 2.3.5 with oneapi/2026.1.0"
