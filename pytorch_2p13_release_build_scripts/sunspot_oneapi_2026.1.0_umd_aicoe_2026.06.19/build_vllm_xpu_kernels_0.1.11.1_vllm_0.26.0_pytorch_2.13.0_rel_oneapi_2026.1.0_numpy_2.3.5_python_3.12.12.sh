...
CONDA_ENV_NAME=vllm_xpu_kernels_0.1.11.1_vllm_0.26.0_nre_pt_2.13.0_rel_one_2026.1.0_np_2.3.5_python_3.12.12
...
PYTORCH_REPO_DIR=/lus/tegu/projects/datasets/software/26.181.0/wheelforge/repositories/pytorch_2.13.0_patched_08_02_2026/pytorch
TMPDIR_FOR_ENVS=/lus/tegu/projects/datasets/software/26.181.0/wheelforge/envs/tmpdir_for_envs

VLLM_XPU_KERNELS_REPO_DIR=/lus/tegu/projects/datasets/software/26.181.0/wheelforge/repositories/vllm_xpu_kernels_0.1.11.1_07_22_2026
VLLM_REPO_DIR=/lus/tegu/projects/datasets/software/26.181.0/wheelforge/repositories/vllm_0.26.0_08_02_2026
...
## CHANGE HERE!!!
TMP_WORK=/lus/tegu/projects/datasets/software/26.181.0/wheelforge/repositories/vllm_xpu_kernels_0.1.11.1_07_22_2026
cd $TMP_WORK
...
pip install --no-deps "auto_round_lib==0.14.1"
...
echo "Finished building vllm-xpu-kernels/0.1.11.1, triton_xpu_3.7.2 for PyTorch 2.13.0 wheel with numpy 2.3.5 with oneapi/2026.1.0"
...
echo "Finished installing the vllm-xpu-kernels/0.1.11.1 wheel with numpy/2.3.5 and dependencies"
...
echo "Finished building vllm/0.26.0, triton_xpu_3.7.2 for PyTorch 2.13.0 wheel with numpy 2.3.5 with oneapi/2026.1.0"
...
echo "Finished installing the vllm/0.26.0 wheel with numpy/2.3.5 and dependencies"
