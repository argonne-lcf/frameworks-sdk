...
CONDA_ENV_NAME=vllm_xpu_kernels_0.1.12_vllm_0.26.0_nre_pt_2.13.0_rel_one_2026.1.0_np_2.3.5_python_3.12.12
...
VLLM_XPU_KERNELS_REPO_DIR=/lus/tegu/projects/datasets/software/26.181.0/wheelforge/repositories/vllm_xpu_kernels_0.1.12_08_02_2026
...
## CHANGE HERE!!!
TMP_WORK=/lus/tegu/projects/datasets/software/26.181.0/wheelforge/repositories/vllm_xpu_kernels_0.1.12_08_02_2026
cd $TMP_WORK
...
echo "Finished building vllm-xpu-kernels/0.1.12, triton_xpu_3.7.2 for PyTorch 2.13.0 wheel with numpy 2.3.5 with oneapi/2026.1.0"
