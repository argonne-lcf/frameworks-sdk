...
CONDA_ENV_NAME=vision_0.27.x_trtn_3.7.1.x_torch_2.12.0.x_oneapi_2025.3.1_np_2.2.6_py_3.12.12
...
TMP_WORK=/lus/flare/projects/datasets/softwares/envs/repositories/torchvision_03_31_2026
cd $TMP_WORK
...
#git clone org-21003710@github.com:pytorch/vision.git
cd vision
...
echo "Finished building torchvision/0.27.0.x, triton_xpu_3.7.1.x for PyTorch 2.12.0.x wheel with numpy 2.2.6 with oneapi/2025.3.1"
